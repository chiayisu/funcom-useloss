...
from custom.qs_loss import use_prep, custom_use_loss_word
...
class CodeGNNGRUUSEWordModel:
    ...
    def create_model(self):
        ...
        lossf = custom_use_loss_word(self.index_tensor, self.comwords_tensor)

        model.compile(loss=lossf, optimizer=Adam(lr=0.001, clipnorm=20.), metrics=['accuracy'])
